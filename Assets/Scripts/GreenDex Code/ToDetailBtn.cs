...
public class ToDetailBtn : AnimButtonAction {
    ...
    void Start () {
        ...
        //Vector2 pos = this.gameObject.GetComponent<Image>().rectTransform.position;
        //this.gameObject.GetComponent<Image>().rectTransform.position = new Vector2(pos.x +1f, pos.y - 2f);
